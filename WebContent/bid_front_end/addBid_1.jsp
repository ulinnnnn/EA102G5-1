				...
				<div class="row"  >
					...
					<form METHOD="post" ACTION="bid_commodity.do" name="form1" enctype="multipart/form-data" style="margin-top: 30px;">
								...
								<div class="form-group row" style="margin-left: 270px;">
									<label class="col-md-3 control-label">競標商品名稱:</label>
									<div class="col-md-7">
										<input type="TEXT" class="form-control" name="b_name" id="b_name"  style="width:800px"/>
									</div>
								</div>
								<div class="form-group row" style="margin-left: 270px;">
									<label  class="col-md-3 control-label">競標開始時間:</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="b_startime" id="f_date1" style="width:800px">
									</div>
								</div>
								<div class="form-group row" style="margin-left: 270px;">
									<label  class="col-md-3 control-label">競標結束時間:</label>
									<div class="col-md-9">
										<input type="text" class="form-control" name="b_endtime" id="f_date2" style="width:800px">
									</div>
								</div>
								<div class="form-group row" style="margin-left: 270px;">
									<label  class="col-md-3 control-label">競標起始金額:</label>
									<div class="col-md-9">
										<input type="text" name="bs_price" class="form-control" id="bs_price" style="width:800px">
									</div>
								</div>
								<div class="form-group row" style="margin-left: 270px;">
									<label class="col-md-3 control-label">每次加價金額:</label>
									<div class="col-md-9">
										<input type="text" name="bplus_price" class="form-control" id="bplus_price" style="width:800px">
									</div>
								</div>
								<div class="form-group row" style="margin-left: 270px;">
									<label class="col-md-3 control-label">競標商品介紹:</label>
									<div class="col-md-9">
										<textarea name="b_intro" rows="3" cols="30" class="form-control" id="b_intro" style="width:800px"></textarea>
									</div>
								</div>
								<div class="form-group row" style="margin-left: 270px;">
									<label class="col-md-3 control-label">競標商品類別:</label>
									<div>
					...
					<label>檔案預覽: </label>
						<img src="" id="preview2" height="100px" width="100px">
								...
								<br><div class="form-group row">
									<div class=" col-md-12 ">
										<button type="submit" class="btn btn-primary float-center">新增商品</button> 
										<button type="button" class="btn btn-primary float-center" id="insertbutton">神奇按鈕</button>
									</div>
								</div>
								<input type="hidden" name=mem_no value="${memVO.mem_no}">
								<input type="hidden" name="action" value="Bidinsert">						
						</form>
						</div>					
					</div>
...
$('#insertbutton').click(function(){
	$('#b_name').val("BANPRESTO 景品 鬼滅之刃 絆之裝 貳之型 ?門禰豆子 一般色");
	$('#b_intro').val("材質:PVC 尺寸:約15cm");
	$('#bs_price').val(10);
	$('#bplus_price').val(10);
	}) 
